...
public class GameObject implements IModel {
    ...
    public List<GameObject> getGameObjects() throws SlickException {
       ...
       //gameObjects.add(new Special_One());
       //gameObjects.add(new Special_Two());
       //gameObjects.add(new Bananas());
       //gameObjects.add(new Apples());
       //gameObjects.add(new Oranges());
       //gameObjects.add(new Bomb1());
       //gameObjects.add(new Nuclear_Bomb());
